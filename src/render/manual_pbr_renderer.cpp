...
void ManualPBRRenderer::init()
{
    ...
    // ------------------------------------
     lightingShader = new Shader{ "src/shaders/1.colors.vs", "src/shaders/1.colors.fs" };
     lightCubeShader = new Shader{ "src/shaders/1.light_cube.vs", "src/shaders/1.light_cube.fs" };
     skyboxShader = new Shader{ "src/shaders/skybox.vs", "src/shaders/skybox.fs" };
     manualPBR = new Shader{ "src/shaders/manual_pbr.vs", "src/shaders/manual_pbr.fs" };
