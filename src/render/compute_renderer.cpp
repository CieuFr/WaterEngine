...
void ComputeRenderer::init()
{
    ...
    // -------------------------
     screenQuadShader = new Shader{ "src/shaders/screen_space_quad.vs", "src/shaders/screen_space_quad.fs" };
     computeShader = new ComputeShader{ "src/shaders/compute_test.cs"  };
